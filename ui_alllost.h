/********************************************************************************
** Form generated from reading UI file 'alllost.ui'
**
...
public:
    ...
    void setupUi(QDialog *AllLost)
    {
        if (AllLost->objectName().isEmpty())
            AllLost->setObjectName("AllLost");
        AllLost->resize(1536, 801);
        AllLost->setMaximumSize(QSize(1536, 16777215));
        QIcon icon;
        icon.addFile(QString::fromUtf8("Image/guet.png"), QSize(), QIcon::Normal, QIcon::Off);
        AllLost->setWindowIcon(icon);
        widget = new QWidget(AllLost);
        ...
        confirm = new QPushButton(AllLost);
        confirm->setObjectName("confirm");
        confirm->setGeometry(QRect(960, 130, 101, 31));
        confirm->setFont(font);
        confirm->setFocusPolicy(Qt::NoFocus);
        reset = new QPushButton(AllLost);
        reset->setObjectName("reset");
        reset->setGeometry(QRect(1100, 130, 101, 31));
        reset->setFont(font);
        reset->setFocusPolicy(Qt::NoFocus);
        tableWidget = new QTableWidget(AllLost);
        tableWidget->setObjectName("tableWidget");
        tableWidget->setEnabled(true);
        tableWidget->setGeometry(QRect(30, 180, 1481, 561));
        tableWidget->setFont(font);
        tableWidget->setFocusPolicy(Qt::NoFocus);
        exit = new QPushButton(AllLost);
        exit->setObjectName("exit");
        exit->setGeometry(QRect(1410, 750, 101, 31));
        exit->setFont(font);
        exit->setFocusPolicy(Qt::NoFocus);

        retranslateUi(AllLost);

        QMetaObject::connectSlotsByName(AllLost);
    } // setupUi

    void retranslateUi(QDialog *AllLost)
    {
        AllLost->setWindowTitle(QCoreApplication::translate("AllLost", "\345\244\261\347\211\251\346\261\207\346\200\273", nullptr));
        label->setText(QCoreApplication::translate("AllLost", "\347\224\250\346\210\267\357\274\232", nullptr));
        lineEdit->setPlaceholderText(QCoreApplication::translate("AllLost", "\346\250\241\347\263\212\346\220\234\347\264\242\350\276\223\345\205\245", nullptr));
        pushButton->setText(QCoreApplication::translate("AllLost", "\344\277\256\346\224\271", nullptr));
        label_6->setText(QCoreApplication::translate("AllLost", "\347\211\251\345\223\201\357\274\232", nullptr));
        lineEdit_2->setPlaceholderText(QCoreApplication::translate("AllLost", "\346\250\241\347\263\212\346\220\234\347\264\242\350\276\223\345\205\245", nullptr));
        pushButton_2->setText(QCoreApplication::translate("AllLost", "\344\277\256\346\224\271", nullptr));
        label_2->setText(QCoreApplication::translate("AllLost", "\346\227\266\351\227\264\350\214\203\345\233\264\357\274\232", nullptr));
        label_5->setText(QCoreApplication::translate("AllLost", "\345\271\264", nullptr));
        label_4->setText(QCoreApplication::translate("AllLost", "\346\234\210", nullptr));
        label_3->setText(QCoreApplication::translate("AllLost", "\346\227\245~", nullptr));
        label_7->setText(QCoreApplication::translate("AllLost", "\345\271\264", nullptr));
        label_8->setText(QCoreApplication::translate("AllLost", "\346\234\210", nullptr));
        label_9->setText(QCoreApplication::translate("AllLost", "\346\227\245", nullptr));
        confirm->setText(QCoreApplication::translate("AllLost", "\346\237\245\350\257\242", nullptr));
        reset->setText(QCoreApplication::translate("AllLost", "\351\207\215\347\275\256", nullptr));
        exit->setText(QCoreApplication::translate("AllLost", "\351\200\200\345\207\272", nullptr));
    } // retranslateUi

};

namespace Ui {
    class AllLost: public Ui_AllLost {};
} // namespace Ui
